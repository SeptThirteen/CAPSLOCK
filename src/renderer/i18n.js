...
const translations = {
  en: {
    ...
    mapping: {
      ...
      clearBtn:           'Clear',
      keyNotice:          'Type a key name (e.g. escape, ctrl, f5, a) or click Record.',
      ...
      addStepBtn:         '+ Add Step',
      macroNotice:        'Steps execute in order. Use \u2018type\u2019 for typing text, \u2018delay\u2019 for a pause (ms).',
      stepKeydown:        'keydown',
      stepKeyup:          'keyup',
      stepType:           'type',
      stepDelay:          'delay (ms)',
  ...
  zh: {
    ...
    mapping: {
      ...
      recordKeyBtn:       '\u5f55\u5236\u6309\u952e',
      clearBtn:           '\u6e05\u9664',
      keyNotice:          '\u8f93\u5165\u6309\u952e\u540d\u79f0\uff08\u5982 escape\u3001ctrl\u3001f5\u3001a\uff09\u6216\u70b9\u51fb\u5f55\u5236\u3002',
      recordComboBtn:     '\u5f55\u5236\u7ec4\u5408\u952e',
      clearAllBtn:        '\u5168\u90e8\u6e05\u9664',
      comboNotice:        '\u540c\u65f6\u6309\u4f4f\u4fee\u9970\u952e\u548c\u76ee\u6807\u952e\uff0c\u7136\u540e\u70b9\u51fb\u5f55\u5236\u7ec4\u5408\u952e\u3002',
      comboEmpty:         '\u672a\u8bbe\u7f6e\u6309\u952e \u2014 \u8bf7\u70b9\u51fb\u5f55\u5236\u7ec4\u5408\u952e',
      addStepBtn:         '+ \u6dfb\u52a0\u6b65\u9aa4',
      macroNotice:        '\u6b65\u9aa4\u6309\u987a\u5e8f\u6267\u884c\u3002\u4f7f\u7528\u300c\u8f93\u5165\u6587\u5b57\u300d\u8f93\u5165\u6587\u672c\uff0c\u4f7f\u7528\u300c\u5ef6\u8fdf\u300d\u8bbe\u7f6e\u6682\u505c\u65f6\u95f4\uff08\u6beb\u79d2\uff09\u3002',
      stepKeydown:        '\u6309\u4e0b',
      stepKeyup:          '\u677e\u5f00',
      stepType:           '\u8f93\u5165\u6587\u5b57',
      stepDelay:          '\u5ef6\u8fdf\uff08\u6beb\u79d2\uff09',
